...
exports.seed = async function(knex) {
  ...
  await knex('project_table').insert([
    {name: 'Smart Energy Management System', problem_statement: "We need a system that can monitor energy consumption patterns in real-time and suggest automated adjustments to optimize energy usage and reduce costs.", submitter_id: 7, is_approved: true, is_accepted: false, accepted_by_id: 1, is_completed: false, bounty_payout: 200, github_url: '', coders_needed: 1},
    {name: 'Healthcare Appointment Scheduler', problem_statement: "The current appointment scheduling process in our healthcare facility is inefficient. We require software that can streamline scheduling, send reminders, and manage patient appointments seamlessly.", submitter_id: 2, is_approved: true, is_accepted: false, accepted_by_id: 1, is_completed: false, bounty_payout: 100, github_url: '', coders_needed: 2},
